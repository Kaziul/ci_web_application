                ...
                <div class="card">
                    <div class="card-header">
                        <div class="card-title">
                            <form action="" id="searhFrm" class="searhFrm" method="get">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <?php
                                                ...
                                                <img class="w-100" src="<?php echo base_url('public/uploads/articles/thumb_admin/no_image.png') ?>" alt="">
                                        ...
                                        <td>
                                            <a href="<?php echo base_url('admin/article/edit/') . $article['id']; ?>" class="btn btn-primary"><i class="far fa-edit"></i></a>
                                            <a href="javascript:void(0);" onclick="deleteArticle(<?php echo $article['id'] ?>)" class="btn btn-danger"><i class="far fa-trash-alt"></i></a>
                                        </td>
                                    </tr>
