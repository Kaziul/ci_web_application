                        ...
                        <div class="card-body">
                            ...
                            <form action="<?php echo base_url('page/contact'); ?>" method="post" id="contact-form" name="contact-form">
                                <div class="form-group">
                                    ...
                                    <input type="text" <?php echo set_value('name') ?> name="name" id="name" class="form-control <?php echo (form_error('name') != '') ? 'is-invalid' : ''; ?>">
                                    <?php echo form_error('name') ?>
                                </div>
                                <div class="form-group">
                                    <label for="email">Emaiemail</label>
                                    <input type="email" <?php echo set_value('email') ?> name="email" id="email" class="form-control <?php echo (form_error('email') != '') ? 'is-invalid' : ''; ?>">
                ...
                <div class="col-md-4">
                    <div class="card  h-100">
                        ...
                        <div class="card-body">
                            ...
                            <p class="mb-0">Las vegs street 201</p>
