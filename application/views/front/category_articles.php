            ...
            <div class="row mb-5">
                <div class="col-md-4">
                    <?php if (!empty($article['image'])) { ?>
                        <img class=" w-100  rounded" src="<?php echo base_url('public/uploads/articles/thumb_admin/' . $article['image']); ?>" alt="">
                    <?php } ?>
                </div>
                <div class="col-md-8">
                    ...
                    <p>
                        <?php echo word_limiter(strip_tags($article['description']), 40); ?>
